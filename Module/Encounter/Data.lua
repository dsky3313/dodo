...
dodo.EncounterEvents = {
    [658] = { -- 사론의 구덩이
        -- 제련장인 가프로스트
        { eventID = 144, role = "Tank"    , sound = "Tank"     }, -- 광석 파괴자
        { eventID = 145, role = "Heal" },                         -- 냉각 발구르기
        { eventID = 146, role = "Other" },                        -- 사로나이트 던지기
        { eventID = 147, role = "Mechanic", sound = "Phase"    }, -- 빙하 과잉
        -- 이크와 크리크
        { eventID = 203, role = "Mechanic", sound = "Phase"    }, -- 이크, 물어뜯어!
        { eventID = 204, role = "Other" },                        -- 망령의 이동
        { eventID = 205, role = "Heal" },                         -- 역병 배출
        { eventID = 206, role = "Tank"    , sound = "Tank"     }, -- 역병 강타
        { eventID = 560, role = "Mechanic", sound = "Phase"    }, -- 육중한 집착
        -- 스컬지군주 티라누스
        { eventID = 164, role = "Tank"    , sound = "Tank"     }, -- 스컬지군주의 낙인
        { eventID = 165, role = "Mechanic", sound = "Phase"    }, -- 사자의 군대
        { eventID = 166, role = "Heal" },                         -- 서릿발 작렬
        { eventID = 167, role = "Heal" },                         -- 해골 주입
        { eventID = 168, role = "Other" },                        -- 망자의 손아귀
        { eventID = 375, role = "Mechanic", sound = "Phase"    }, -- 얼음 탄막
    },
    ...
    [1209] = { -- 하늘탑
        ...
        { eventID = 310, role = "Mechanic", sound = "Phase"    }, -- 내려놓기
        { eventID = 311, role = "Other" },                        -- 태양 작렬
        { eventID = 312, role = "Mechanic", sound = "Phase"    }, -- 렌즈 반사광
    },

    [1753] = { -- 삼두정의 권좌
        -- 승천자 주라알
        { eventID = 223, role = "Other" },                        -- 무효의 손바닥
        { eventID = 224, role = "Mechanic", sound = "Phase"    }, -- 척살
        ...
        { eventID = 250, role = "Mechanic", sound = "Phase"    }, -- 불협의 광선
    ...
    [2526] = { -- 알게타르 대학
        ...
        { eventID = 275, role = "Heal"    , sound = "AOE"      }, -- 마나 폭탄
        { eventID = 276, role = "Tank"    , sound = "Frontal"  }, -- 비전 방출
        { eventID = 277, role = "Mechanic", sound = "Mechanic" }, -- 비전 균열
        -- 비대해진 고대정령
        { eventID = 282, role = "Tank"    , sound = "Tank"     }, -- 나무껍질 파괴자
        { eventID = 283, role = "Other" },                        -- 가지 뻗기
        { eventID = 284, role = "Mechanic" },                     -- 발아
        { eventID = 285, role = "Heal"    , sound = "AOE"      }, -- 밀려드는 분출
        -- 크로스
        { eventID = 278, role = "Tank"    , sound = "Tank"     }, -- 흉포한 쪼기
        { eventID = 279, role = "Heal"    , sound = "AOE"      }, -- 귀청 터질듯한 비명
        { eventID = 280, role = "Other"   , sound = "Frontal"  }, -- 압도적인 돌풍
        { eventID = 397, role = "Mechanic", sound = "Phase"    }, -- 공놀이
        -- 도라고사의 메아리
        { eventID = 293, role = "Other" },                        -- 신비한 화살
        { eventID = 294, role = "Tank"    , sound = "Tank"     }, -- 천공의 작렬
        { eventID = 295, role = "Heal" },                         -- 마력 폭탄
        { eventID = 296, role = "Mechanic", sound = "Phase"    }, -- 힘의 공백
    },
    ...
    [2805] = { -- 윈드러너 첨탑
        ...
        { eventID = 29,  role = "Mechanic", sound = "Phase"    }, -- 힘껏 당기기
        -- 지휘관 크롤루크
        { eventID = 210, role = "Tank"    , sound = "Tank"     }, -- 광란
        { eventID = 211, role = "Mechanic", sound = "Phase"    }, -- 위협의 외침
        { eventID = 212, role = "Heal" },                         -- 무모한 도약
        { eventID = 213, role = "Mechanic", sound = "Phase"    }, -- 위협의 외침
    ...
    [2874] = { -- 메아리치는 동굴
        ...
        { eventID = 152, role = "Mechanic", sound = "Phase"    }, -- 빙결 덫
        ...
        { eventID = 19,  role = "Mechanic", sound = "Phase"    }, -- 악령 왜곡
        { eventID = 20,  role = "Heal" },     -- 괴저의 수렴
        { eventID = 429, role = "Mechanic", sound = "Phase"    }, -- 최후의 추적
    ...
    [2915] = { -- 공결탑 제나스
        ...
        { eventID = 36,  role = "Mechanic", sound = "Phase"    }, -- 무위의 선봉대
