...
local function update_event_registration()
    ...
    local useSync = (dodoDB and dodoDB.useAudioSync ~= false)
    local useBossStart = (dodoDB and dodoDB.useSoundEncounterStart ~= false)
    local useBossVictory = (dodoDB and dodoDB.useSoundEncounterVictory ~= false)
