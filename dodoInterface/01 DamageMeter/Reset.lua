...
local function update_state()
    local is_enabled = dodoDB and dodoDB.enableInterface ~= false and dodoDB.dmgMeterResetButton ~= false
...
local function on_auto_reset_event(self, event)
    ...
    elseif event == "CHALLENGE_MODE_START" then
        if dodoDB.enableInterface ~= false and dodoDB.dmgMeterAutoResetMplus ~= false then
            C_DamageMeter.ResetAllCombatSessions()
        end
    end
end
