...
function dodoEncounterPreviewMixin:Update()
	...
	if tab == "text" then
		...
		local icon_sz   = dodoDB.encounterTextIconSize or TEXT_ICON_SIZE_DEF
		local font_sz   = dodoDB.encounterTextFontSize or TEXT_FONT_SIZE_DEF
	...
	local use_color      = dodoDB.enableEncounterTimelineColor ~= false
	local highlight      = use_color and dodoDB.useEncounterTimelineColorHighlight ~= false
